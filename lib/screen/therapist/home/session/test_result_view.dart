          ...
          body: Padding(
            ...
            child: Column(
              children: [
                ...
                Obx(() => container(generateRows(controller.result.value ?? Scl90ResultModel()))),
                testViewPageButton(
...
Align testViewPageButton(Function() onTap, String buttonText) {
  return Align(
   ...
   List<TableRow> generateRows(Scl90ResultModel result) => List.generate(categories.length + 1, (index) {
    if (index == 0)
      ...
      return tableRow(categories[index - 1],
          getPoints(result)[index-1], false);
  });
