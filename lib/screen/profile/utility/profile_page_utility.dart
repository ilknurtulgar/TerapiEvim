...
class ProfilePageUtility {
  static Column backgroundOfThePage(bool isInProfileSettingsPage) => Column(
    children: [
      ...
      Container(
        height: isInProfileSettingsPage ? window.physicalSize.height-162 : 678,
        width: window.physicalSize.width,
  ...
  static Positioned positionedIconButton(IconData icon,Function() onPressed,double top,double right)=> Positioned(
              top: top,
              right: right,
              child: IconButton(
                  onPressed: onPressed,
  ...
  static Align profilePagePersonImage(String imagePath) => Align(
        ...
        child: Padding(
          ...
          child: CustomCircleAvatar(imagePath: imagePath,big: true,shadow: true),
        ),
      );

  static RowModel therapistRow(String whichTherapistInformationText,String therapistName)=> RowModel( // ana ve yardımcı terapist için
  ...
  static RowModel boldMainTitleRow(String text,IconData icon,Function() onTap) => RowModel(
      text: text,
      leadingIcon: Icon(icon,color: AppColors.black,size: 25,),
  ...
  static RowModel normalTextRow(String text,IconData icon,TextStyle textStyle) => RowModel(
      text: text,
      leadingIcon: Icon(icon,color: AppColors.black,),
      textStyle: textStyle,
      isAlignmentBetween: false); //TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 20),
  ...
  static Padding lineWithOrText() {
    return Padding(
        ...
        child: Row(
          ...
          children: [
            horizontalLine(),
            const Padding(padding: EdgeInsets.symmetric(horizontal: 5),child: Text('Ya da'),
            ),
            horizontalLine()             
          ],
        ),
