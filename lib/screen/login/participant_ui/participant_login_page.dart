...
class ParticipantLoginPage extends StatelessWidget {
  ...
  final TextEditingController passwordControllerLoginPage = TextEditingController();
    ...
    return Scaffold(
      ...
      body: Column(
          ...
          children: [
            ...
            textfieldUtility.passwordTextfield(passwordControllerLoginPage, true),
            forgotYourPasswordTextButton(),
            CustomButton(container: ProfilePageUtility.loginSignUpButtonContainer(true, true),onTap: () {/* giriş yapma fonksiyonu*/},text: 'Giriş Yap',),
            ProfilePageUtility.lineWithOrText(),
            CustomButton(container: ProfilePageUtility.loginSignUpButtonContainer(true, false),onTap: () => Get.to(() => const ParticipantSignUpPage()),text: 'Kaydol',),
  ...
  Padding forgotYourPasswordTextButton() {
    return Padding(
        ...
        child: TextButton(
            ...
            child: const Text('Şifreni mi unuttun?',style: TextStyle(color: AppColors.meteorite),
            )));
  }
  ...
  Padding loginPageTitle() {
    return const Padding(
      ...
      child: Text('Giriş Yap', style: AppTextStyles.loginSignUpBigTitle,),
    );
  }
}
