...
import '../../../components/container/participant_container.dart';
...
class GroupInformationContainer extends StatelessWidget {
  ...
  Column insideTheContainer() {
    return Column(
          ...
          children: [
            ...
            therapistRow(mainTherapist, 'Grup Terapisti: ', () { print('ana psikolog') ;}, 192),
            therapistRow(secondTherapist, 'Yardımcı Psikolog: ', () { print('yardımcı psikolog') ;}, 170),
            ...
            Align(
              ...
              child: CustomButton(container: AppContainers.purpleButtonContainer,onTap:(){},text: 'Katıl',)),
  ...
  Row therapistRow(CardModel therapist, String text, Function() func,double width) {
    return Row(
      children: [
        Text(text,style: AppTextStyles.GroupTextStyle(true)),
        InkWell(
          onTap: func,
          child: participantContainer(therapist, 50, width,)),
      ],
    );
  }
}
