...
class CustomVideoCallButton extends StatefulWidget {
  const CustomVideoCallButton({super.key,required this.onTap,required this.isThisOn,required this.icon,this.offIcon,required this.backgroundColor});
...
class _CustomVideoCallButtonState extends State<CustomVideoCallButton> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: widget.icon==IconUtility.micIcon(true) ? const EdgeInsets.symmetric(horizontal: 20) : const EdgeInsets.symmetric(vertical: 15),
